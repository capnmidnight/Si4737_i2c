...
void setup() {
    ...
    */
    ...
    //radio.sendCommand(SI4737_CMD_POWER_UP, 0xC0, 0xB5);  // Send Power-up command, enable interrupts, set external clock source, set device to FM mode, enable digital and analog audio outputs.
